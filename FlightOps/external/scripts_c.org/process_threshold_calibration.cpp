// This is a C++ ROOT-based program converted from process_threshold_calibration.py 
// I need to check the functionality... by Ken  
...
int main(int argc, char** argv) {
    ...
    if (argc < 4) {
        cerr << "Usage: ./program --config CONFIG -i INPUT_PREFIX -o OUTPUT_FILE [--root-file ROOT_FILE]" << endl;
        return 1;
    }

    string configFile, inputFilePrefix, outFileName, rootFileName;
