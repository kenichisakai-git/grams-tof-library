...
int main(int argc, char** argv) {
    ...
    if (!runProcessQdcCalibration(configFileName, inputFilePrefix, outputFilePrefix, tmpFilePrefix, doSorting, keepTemporary, nominalM)) {
        std::cerr << "QDC calibration failed.\n";
        return 1;
    }
